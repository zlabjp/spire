...
`,
		...
		COMMIT;
		`,
		// future v10 database entry, in which index was added to registration_entries expiry field
		`
		PRAGMA foreign_keys=OFF;
		BEGIN TRANSACTION;
		CREATE TABLE IF NOT EXISTS "federated_registration_entries" ("bundle_id" integer,"registered_entry_id" integer, PRIMARY KEY ("bundle_id","registered_entry_id"));
		...
		COMMIT;
		`,
		// future v11 database entry, in which default field was added to registration_entries
	}
)
